...
import { Calendar, MapPin, Phone, User, Clock, Users } from "lucide-react";
...
const todaysEvents = [
  {
    id: 1,
    date: "17-09-2025",
    location: "H.No-157-D, Street No-4, Mehal Mubarak Colony, Sangrur, Punjab 148001",
  ...
  },
  {
    id: 2,
    date: "17-09-2025",
    location: "25A Nandan Road, Near Netaji Bhaban Metro Station, Kolkata, West Bengal 700025",
...
const upcomingEvents = [
  {
    id: 1,
    date: "23-09-2025",
    location: "Shella Bypass To Sonipat Road, 1st Floor, Rohtak, Haryana 124001",
  ...
  },
  {
    id: 2,
    date: "22-09-2025",
    location: "Shop No. 91, Near Shri Ram Healthcare, Dabwali Road, Sirsa, Haryana 125055",
  ...
  },
  {
    id: 3,
    date: "22-09-2025",
    location: "#18, Krishna Nagar Industrial Area, Near Christ College, Hosur Main Road, Koramangala, Bangalore, Karnataka 560029",
  ...
  },
  {
    id: 4,
    date: "20-09-2025",
    location: "B-13, Block-B Ranjeet Avenue Inside Lakme Saloon Street, Amritsar, Punjab 143001",
...
export default function Camps() {
  ...
  return (
    <section id="camps" className="py-20 bg-white" ref={ref}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Stay informed about our upcoming health check-up events to enhance your 
                    ...
                    <CardContent className="p-6">
                      ...
                      <div className="space-y-3 mb-6">
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          <p className="text-gray-600 text-sm">{event.doctor}</p>
                        </div>
                        <div className="flex items-center space-x-3">
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <h3 className="text-2xl font-bold text-gray-900 mb-8 text-center">Special Camp Programs</h3>
        ...
        >
          <div className="warm-gradient-bg rounded-2xl p-8 md:p-12 border border-orange-200">
            ...
            <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
              We organize health camps across India. Contact us to bring our expert 
              Ayurvedic doctors and natural healing services to your community.
            </p>
